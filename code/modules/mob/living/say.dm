...
/mob/living/proc/can_speak_basic(message, ignore_spam = FALSE) //Check BEFORE handling of xeno and ling channels
	...
	var/static/regex/memes = regex("рофляныч|рофелька|футанари|фута|камбой|фембой|майнкрафт|медведь и бык|флоппа|флопа|либерахи|либераха|либераху|траповод|хохол|хохлу|хохлам|тритор|метагей|хохлы|хохляндия|каклошвайн|двач|украинцы|украинец|украинцу|пидораху|пидораха|пидорахе|рпшер|спидранер|лабеб|педаль|педалька|педали|педалятор|педалями|педальная|педальное|лутать|лут|лутецкий|ерп|залутать|лутер|спидран|спидранить|заспидранил|хорни|вайб|фури|фурятина|фуричка|вайбов|вайбер|чирик|ванотян|сорри|коксакингом|коксакинг|коксак|коксакер|сорян|соряныч|сорямба|рофлябма|рофлыч|ауе|ролевой плей|ролевой рп|жигуль|жигули|жигулик|pog|поггерс|погчамп|ролеплеер|ральплеер|кек|кекыч|кекчик|грифер|грифонер|грифозник|хентай|трап|тян|тяночка|лоли|лоля|вайфу|лукашенко|путин|lmao|ayy|lol|kek|cheburek|ежжи|спанчбоб|рофл|uwu|owo|0w0|@w@|>w<|обэма|>w>|blacklivesmatters|BLM|вуася|алейкум|украина|зеленский", "i")
